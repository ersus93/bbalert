#!/usr/bin/env python3
"""
Test script to verify the interval fix for price alerts on bot restart.

This script tests the logic in programar_alerta_usuario function to ensure
that when the bot restarts, it respects the user-configured interval instead
of sending price lists immediately.
"""
