...
HELP_FULL = {
    "es": (
        ...
        "  • `/prices`: Gestiona tu lista de monedas (ver precios, añadir, eliminar). 📊\n"
    ...
    "en": (
        ...
        "  • `/prices`: Manage your coin list (view prices, add, remove). 📊\n"
